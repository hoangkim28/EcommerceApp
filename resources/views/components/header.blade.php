  ...
  <div class="flex items-center justify-between mx-auto max-w-6xl px-4 pb-2 pt-3 md:pt-4">
    <a class=" cursor-pointer" href="/">
      <h1 class="flex no-underline mr-2">
        ...
        <span class="text-xl md:text-2xl text-black font-primary font-bold tracking-tight pt-1  block">
    ...
    @if($categories)
        <div class="bg-gray-100">
            <div class="max-w-6xl mx-auto py-1 md:px-0 border-b border-t border-gray-200">
                <div class="hidden md:inline-flex space-x-8 px-8 md:px-4 lg:px-0">
