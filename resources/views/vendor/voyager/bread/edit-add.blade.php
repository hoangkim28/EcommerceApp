...
@section('page_header')
    <h1 class="page-title">
        ...
        @if($edit && $dataTypeContent->name)
        Chỉnh sửa {{$dataType->getTranslatedAttribute('display_name_singular')}}: <span style="font-size: 20px; color:black;">{{$dataTypeContent->name}}</span>
        @else
