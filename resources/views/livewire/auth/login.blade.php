...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        @if (Route::has('register'))
            <p class="mt-2 text-sm text-center text-gray-600 leading-5 max-w font-primary">
                Hoặc
                <a href="{{ route('register') }}" class="font-primary font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
            ...
            <form wire:submit.prevent="authenticate">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="block ml-2 text-sm font-primary text-gray-900 leading-5">
                            Lưu thông tin đăng nhập
                        </label>
                    </div>

                    <div class="text-sm leading-5">
                        <a href="{{ route('password.request') }}" class="font-medium font-primary text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">
                            Quên mật khẩu?
                        </a>
                    </div>
                </div>
